...
&nbsp;&nbsp;
    <asp:TextBox ID="IdDiscoTextBox" runat="server" Width="97px"></asp:TextBox>
&nbsp;&nbsp;
...
&nbsp;
    <asp:TextBox ID="PrecioTextBox" runat="server" Width="86px"></asp:TextBox>
&nbsp;&nbsp;
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TotalTextBox" runat="server" Width="113px"></asp:TextBox>
    <br />
    <br />
    <br />
                        </div></div></div></div>
